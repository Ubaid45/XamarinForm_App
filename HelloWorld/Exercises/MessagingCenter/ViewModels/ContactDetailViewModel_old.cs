...
{
	public class ContactDetailViewModel_Old 
	{
		...
		public ContactDetailViewModel_Old(ContactViewModel viewModel, IContactStore contactStore, IPageService pageService)
		{
			if (viewModel == null)
