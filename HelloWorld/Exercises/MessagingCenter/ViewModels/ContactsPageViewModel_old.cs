...
{
	public class ContactsPageViewModel_old : BaseViewModel
	{
		...
		public ContactsPageViewModel_old(IContactStore contactStore, IPageService pageService)
		{
			...
			//TODO: Commented because it was old file and generating error
